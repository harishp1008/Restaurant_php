...
.controller('myController', function ($scope) {
  ...
  $scope.maincourse = [
    { id :  1, category : "Tuscan Tomato Bread Soup with Steamed Mussels", description : "There are many versions of bread soup; this one, based on traditional peasant fare, is as thick as a bread pudding.",   price :   2.99, qty : 1 },
    ...
    { id : 11, category : "Chicken Parmesan",         description : "A taste of the Mediterranean in one delicious baked chicken dish.",        price : 1.22, qty : 1 }
  ];
  $scope.Starter = [
